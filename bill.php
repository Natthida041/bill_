...
<body>
    ...
    <div class="container">
        ...
        <main class="content">
            <h1>ข้อมูลสำหรับการออกใบเสร็จรับเงินย้อนหลัง</h1>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <button type="submit" name="view_bill">ดูใบเสร็จรับเงินย้อนหลัง</button>
            </form>
            <?php if (!empty($bill_details)): ?>
                <div class="printable">
                    <h2>ใบเสร็จรับเงินย้อนหลัง</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>ตามอัตรา</td>
                                <td><?php echo htmlspecialchars($bill_details['water_cost']); ?></td>
                            </tr>
                            <tr>
                                <td>ค่าห้อง</td>
                                <td>1</td>
